...
static const ggml_type_traits_t type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_1] = {
        ...
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_q4_1_q8_1,
    ...
    [GGML_TYPE_Q5_0] = {
        ...
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_q5_0_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
    },
    [GGML_TYPE_Q5_1] = {
        ...
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_q5_1_q8_1,
        .vec_dot_type             = GGML_TYPE_Q8_1,
    },
    [GGML_TYPE_Q8_0] = {
    ...
    [GGML_TYPE_Q4_K] = {
        ...
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_q4_K_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
    },
    [GGML_TYPE_Q5_K] = {
        ...
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_q5_K_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
    },
    [GGML_TYPE_Q6_K] = {
        ...
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_q6_K_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
    },
    [GGML_TYPE_Q8_K] = {
